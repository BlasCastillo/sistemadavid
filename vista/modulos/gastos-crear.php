<div class="container-fluid px-0">
    ...
    <div class="row"><div class="col-md-8"><div class="card-reditus p-4 shadow border-0 border-top border-primary border-3"><div class="card-body p-4">
        <form id="formAgregarGasto" autocomplete="off">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-dodger fw-bold px-4"><i class="fas fa-save me-2"></i> Guardar Egreso</button>
            </div>
        </form>
    </div></div></div></div>
</div>
