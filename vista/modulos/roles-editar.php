                    ...
                    <form id="formPermisosRol">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- NUEVO PERMISO DE CONCILIACIONES INYECTADO AQUÍ -->
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input border-danger" type="checkbox" name="permisosActivos[]" value="conciliar_pagos" id="chk_conciliar_pagos" <?php echo in_array("conciliar_pagos", $permisos) ? 'checked' : ''; ?>>
                                    <label class="form-check-label text-danger" for="chk_conciliar_pagos">Auditar / Conciliar Pagos Bancarios</label>
                                </div>
